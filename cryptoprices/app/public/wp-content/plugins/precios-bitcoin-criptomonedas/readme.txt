...
Donate Link: https://bit.ly/wp-cm-plugin-donate
Tags: bitcoin, cryptocurrencies, trading, criptomonedas, cryptocurrency plugin, bitcoin plugin
...
Free plugin with a price table of top cryptocurrencies. Earn money by inviting users to Coinmotion through a referral link embedded in the plugin.

== Description ==

### Bitcoin Value - Wordpress Plugin

This free plugin shows real-time prices of Bitcoin, Ethereum, Ripple, Litecoin and Stellar Lumens on your website with 4 different widgets:

* It includes a **price chart** of BTC, ETH, XRP, LTC and XLM (some of the best cryptos in the market).
* **Crypto to fiat conversor**.
...
* Possibility of locating the price table in a sidebar widget.
* Carousel shortcode to be able to show the table wherever you want without any restriction.
...
You must have either a personal or a business account in Coinmotion. [Create a free account from here](https://app.coinmotion.com/en/register/signup?referral_code=WIDGET_REFERRAL). Once the account is created, you can find your referral code from here: https://app.coinmotion.com/en/referrals

**Here you’ll find an invitation link but you should only copy the code after the equals sign. Here’s an example:**
https://app.coinmotion.com/en/register/signup?referral_code=**xxxxxxxxxx**
...
== Screenshots ==
1. **Configuration Panel.** Coinmotion will create a quick access in the administrator menu from which you can configure the currency, language, texts, colors.
2. **Widget.** The plugin will also create 3 widgets in Appearance ==> Widgets with a configuration form in which you can also change the design, cryptocurrency and data.
3. **Example of vertical carousel shortcode.** Screenshot of Coinmotion vertical price list on a web.
4. **Example of horizontal carousel shortcode.** Screenshot of the price list on a web.
5. **Another example of sidebar crypto price evolution widget.**
6. **Calculator crypto-fiat.** Screenshot showing the sidebar calculator.
7. **Historical data widget in the sidebar.**
...
= 2.0.0 =
Full revamp of the plugin with 3 new widgets and +100 currencies.

= 1.0.7 =
Two strings were translated. Some texts have been updated

= 1.0.6 =
USA English is the base language. Fixed code translation problems

= 1.0.5 =
Finnish language has been added

...
function coinmotion_admin_settings_page(){
    ...
    if ($updated !== ""){
        if (($updated == true) || ($updated == "-")){
            ...
            echo '<div class="error notice" style="padding: 20px;"><strong>' .  __( 'Error', 'coinmotion' ) . '</strong> ' . __( 'There are a problem updating data.', 'coinmotion' ) . '</div>' ;
        }
    }
...
function coinmotion_home_tab(){
    ...
    <a class="nav-tab <?php echo $coinmotion_active_tab == 'home' || '' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=coinmotion_plugin_config_page&tab=home' ); ?>"><?= __( 'Home', 'coinmotion' ) ?> </a>
    <?php
}
...
function coinmotion_button_tab(){
    global $coinmotion_active_tab;
    ?>
    <a class="nav-tab <?php echo $coinmotion_active_tab == 'button-tab' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=coinmotion_plugin_config_page&tab=button-tab' ); ?>"><?= __( 'Referral button', 'coinmotion' ); ?> </a>
    <?php
}
...
function coinmotion_widget_rate_period_tab(){
    global $coinmotion_active_tab;
    ?>
    <a class="nav-tab <?php echo $coinmotion_active_tab == 'widget-rate-period-tab' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=coinmotion_plugin_config_page&tab=widget-rate-period-tab' ); ?>"><?= __( 'Price evolution', 'coinmotion' ); ?> </a>
    <?php
}
...
function coinmotion_widget_currency_details_tab(){
    global $coinmotion_active_tab; 
    ?>
    <a class="nav-tab <?php echo $coinmotion_active_tab == 'widget-currency-details-tab' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=coinmotion_plugin_config_page&tab=widget-currency-details-tab' ); ?>"><?= __( 'Historical data', 'coinmotion' ); ?> </a>
    <?php
}
...
function coinmotion_widget_currency_conversor_tab(){
    global $coinmotion_active_tab; 
    ?>
    <a class="nav-tab <?php echo $coinmotion_active_tab == 'widget-currency-conversor-tab' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=coinmotion_plugin_config_page&tab=widget-currency-conversor-tab' ); ?>"><?= __( 'Currency/Crypto conversor', 'coinmotion' ); ?> </a>
    <?php
}
...
function coinmotion_carousel_currenct_tab(){
    global $coinmotion_active_tab; 
    ?>
    <a class="nav-tab <?php echo $coinmotion_active_tab == 'carousel-currency-tab' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=coinmotion_plugin_config_page&tab=carousel-currency-tab' ); ?>"><?= __( 'Shortcode Currency/Crypto carousel', 'coinmotion' ); ?> </a>
    <?php
}
...
function coinmotion_widget_rate_period_render_options_page() {
    ...
    <div class="coinmotion_wpseo_content_wrapper_coin">
        <div class="coinmotion_center_plugin">
            ...
            <p><?= __('At the end of this tab you have an explanation of each of the features that you can configure.', 'coinmotion'); ?></p>
            
            <p><?= __('<strong>Header Title</strong>: The header title of the widget', 'coinmotion'); ?></p>
            <p><?= __('<strong>Line Color</strong>: Color of the graph line', 'coinmotion'); ?></p>
            <p><?= __('<strong>Background Color</strong>: Background color of the graph line', 'coinmotion'); ?></p>
            ...
            <p><?= __('<strong>Currency</strong>: Currency in which the data will be displayed', 'coinmotion'); ?></p>
            <p><?= __('<strong>Data</strong>: Type of the data to show, must be Price or Interest', 'coinmotion'); ?></p>
        </div>
    <?php
    require_once( COINMOTION__PLUGIN_DIR . '/admin/sidebar.inc.php');
    ?>
...
function coinmotion_widget_currency_conversor_render_options_page() {
    ...
    <div class="coinmotion_wpseo_content_wrapper_coin">
        <div class="coinmotion_center_plugin">
            ...
            <p><?= __('At the end of this tab you have an explanation of each of the features that you can configure.', 'coinmotion'); ?></p>
            <p><?= __('<strong>Header Title</strong>: The header title of the widget', 'coinmotion'); ?></p>
            <p><?= __('<strong>Text Color</strong>: Color of the text', 'coinmotion'); ?></p>
            <p><?= __('<strong>Background color</strong>: Background color of the conversor', 'coinmotion'); ?></p>
        </div>
    <?php
    require_once( COINMOTION__PLUGIN_DIR . '/admin/sidebar.inc.php');
    ?>
...
function coinmotion_carousel_currency_render_options_page() {
    ...
    <div class="coinmotion_wpseo_content_wrapper_coin">
        <div class="coinmotion_center_plugin">
            ...
            <p><?= __('<strong>show_button</strong>: (on / off). Show the Affiliate button. Default off', 'coinmotion'); ?></p>
            <p><?= __('<strong>cryptos</strong>: (btc,ltc,eth,xrp,xlm). Set the currencies to show. Default btc,ltc,eth,xrp,xlm.', 'coinmotion'); ?></p>
            <p style="height: 2rem"></p>
            <p><?= __('<strong>Shortcode Example</strong>', 'coinmotion'); ?></p>
            <p><i>[coinmotion title="Cotización criptomonedas" cryptos="btc,ltc,eth,xrp,xlm" text_color="black" background="#acacac" orientation="horizontal" show_button="off"]
</i></p>
        </div>
    <?php
    require_once( COINMOTION__PLUGIN_DIR . '/admin/sidebar.inc.php');

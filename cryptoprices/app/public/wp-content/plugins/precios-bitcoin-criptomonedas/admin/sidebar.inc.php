         ...
         <div class="coinmotion_content_cell_coin" id="coinmotion_sidebar-container">
             <div id="coinmotion_sidebar">
                 <div class="coinmotion-sidebar__section_coin">
                     ...
                     ?>
                     <a id="coinmotion-premium-button" class="coinmotion-button-upsell_coin" href="<?= $url ?>/register/signup?referral_code=<?= $params_0['refcode'] ?>&utm_campaign=price_widget_<?= $lang ?>&utm_source=<?= $params_0['refcode'] ?>&utm_medium=plugin_setup_button" target="_blank">

...
class ccpw_database {
	...
	function ccpw_insert($coins_data){
	...
	// specific referrals
		...
		$cache_key = (true === $count) ? filter_var(md5('ccpw_coins_count' . serialize($args)), FILTER_SANITIZE_STRING) : filter_var(md5('ccpw_coins_' . serialize($args)), FILTER_SANITIZE_STRING);
	...
	// specific referrals
		...
		$cache_key = (true === $count) ? filter_var( md5('ccpw_coins_list_count' . serialize($args)), FILTER_SANITIZE_STRING ) : filter_var( md5('ccpw_coins_list_' . serialize($args)), FILTER_SANITIZE_STRING);
